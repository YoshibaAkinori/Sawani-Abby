...
const SalonBoard = () => {
  ...
  const [staffDatabase, setStaffDatabase] = useState([
    ...
    { id: '0004', name: '吉羽 皐紀', color: '#32CD32', isActive: true, holidays: ['2025-09-20', '2025-09-21'] },
  ]);
